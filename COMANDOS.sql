...
INSERT INTO brh.dependente (cpf, colaborador, nome, parentesco, data_nascimento) VALUES ('222.222.222-20', 'F012', 'Cicrana de Tal', 'CÃ´njuge', to_date('1975-06-30', 'yyyy-mm-dd'));
...
UPDATE BRH.COLABORADOR SET NOME = 'Maria Mendonça' WHERE NOME = 'Maria';
